	...
	<script>
		...
		$(function(){
			$('#contentTable').datagrid({
				...
				width:'auto',
				singleSelect: true,
				url: '${ctx}/attachment/list?foreignId=aafee494a2a1',
				pagination:true
			});
		});
	</script>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th field="fileName" width="150" sortable="true" formatter="">文件名称</th>
				<th field="fileCode" width="150" sortable="true" formatter="">文件编码</th>
				<th field="fileRealPath" width="200" sortable="true">文件路径</th>
