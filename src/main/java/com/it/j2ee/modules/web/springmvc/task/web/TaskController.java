 ...
 *******************************************************************************/
package com.it.j2ee.modules.web.springmvc.task.web;
...
import com.it.j2ee.modules.web.springmvc.task.Servlets;
...
//		ShiroUser user = (ShiroUser) SecurityUtils.getSubject().getPrincipal();
		Long userId = Long.parseLong((String)SecurityUtils.getSubject().getPrincipal());
		return userId;
	}
}
